...
<div class="w-full max-w-7xl mx-auto px-2 md:px-8 pb-16 mt-0">
  ...
  <div class="text-xl text-gray-700 text-center mb-2">
    The Official 50+ Nigerian Literary Masterpieces Successfully Read During the Naija ReadFest <span class="text-red-600 font-bold">Guinness World Record – Official Attempt</span>
  </div>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6" id="reading-list-books">
    ...
    $books = [
      ...
      ["The Third Side of a Coin", "Hyginus Ekwuazi"],

<?php // Schedule page for Naija ReadFest PHP version ?>
    ...
    <div class="bg-white rounded-2xl border border-yellow-200 shadow-sm px-6 py-10 mb-12 max-w-6xl mx-auto">
      ...
      <div class="grid md:grid-cols-2 gap-6 mb-8">
        <div class="bg-green-50 border-l-4 border-green-500 rounded-xl p-6 text-left flex flex-col justify-between transition duration-300 transform hover:scale-105 hover:shadow-2xl hover:-translate-y-1">
          <div>
            <div class="text-xl font-bold text-green-800 mb-1">Reading Club</div>
            <div class="font-semibold text-gray-800 mb-2">Multiple Dates within 18 Days</div>
            <div class="text-gray-700">A relaxed, interactive book club for children, teens, and adults featuring storytelling, read-aloud sessions, and fun literacy games.</div>
          </div>
        </div>
        <div class="bg-red-50 border-l-4 border-red-500 rounded-xl p-6 text-left flex flex-col justify-between transition duration-300 transform hover:scale-105 hover:shadow-2xl hover:-translate-y-1">
          <div>
            <div class="text-xl font-bold text-red-700 mb-1">Community Literacy Workshops</div>
            <div class="font-semibold text-gray-800 mb-2">Open sessions for residents</div>
            <ul class="list-disc list-inside text-gray-700">
              <li>Storywriting for beginners</li>
              <li>Introduction to poetry & spoken word</li>
              <li>Drama and creative expression</li>
            </ul>
          </div>
        </div>
        <div class="bg-yellow-50 border-l-4 border-yellow-400 rounded-xl p-6 text-left flex flex-col justify-between transition duration-300 transform hover:scale-105 hover:shadow-2xl hover:-translate-y-1">
          <div>
            <div class="text-xl font-bold text-yellow-700 mb-1">Author Meet-and-Greet Sessions</div>
            <div class="text-gray-700">Engage local authors for fireside chats and Q&A sessions that inspire both young and adult participants.</div>
          </div>
        </div>
        <div class="bg-blue-50 border-l-4 border-green-500 rounded-xl p-6 text-left flex flex-col justify-between transition duration-300 transform hover:scale-105 hover:shadow-2xl hover:-translate-y-1">
          <div>
            <div class="text-xl font-bold text-green-700 mb-1">Press Briefings & Influencer Hangouts</div>
            <div class="text-gray-700">Special sessions for media coverage and influencer engagement to amplify our Guinness World Record – Official Attempt.</div>
          </div>
        </div>
      </div>
      <div class="text-lg mt-4">
